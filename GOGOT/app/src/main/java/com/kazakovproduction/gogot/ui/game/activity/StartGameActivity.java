...
import com.kazakovproduction.gogot.ui.game.dialog.BotDifficultiesDialog;
...
public class StartGameActivity extends AppCompatActivity
    ...
    private void openGameActivity(int amountOfPlayers, BotDifficulty botDifficulty) {
        ...
        intent.putExtra(GameActivity.AMOUNT_OF_PLAYERS, amountOfPlayers);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == GAME_ACTIVITY_RESULT && data != null) {
            if (data.getBooleanExtra(NEED_TO_RESTART_GAME, false)) {
                int playerAmount = data.getIntExtra(GameActivity.AMOUNT_OF_PLAYERS, GameActivity.DEFAULT_PLAYER_AMOUNT);
